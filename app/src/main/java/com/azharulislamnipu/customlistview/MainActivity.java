...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fruitArrayAdapter = new FruitArrayAdapter(getApplicationContext(), R.layout.listview_item);
        ...
        for(String[] fruitData:fruitList ) {
            ...
            int fruitImgResId = getResources().getIdentifier(fruitImg, "drawable", "com.azharulislamnipu.customlistview");
